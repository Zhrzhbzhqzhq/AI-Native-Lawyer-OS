...
ALTER TABLE "documents" ADD CONSTRAINT "fk_documents_argument" FOREIGN KEY ("argument_id") REFERENCES "arguments" ("argument_id") ON DELETE RESTRICT ON UPDATE CASCADE;
