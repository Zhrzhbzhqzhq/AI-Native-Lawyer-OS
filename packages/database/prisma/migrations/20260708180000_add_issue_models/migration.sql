...
ALTER TABLE "issues" ADD CONSTRAINT "fk_issues_matter" FOREIGN KEY ("matter_id") REFERENCES "matters" ("matter_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "issue_fact" ADD CONSTRAINT "fk_issue_fact_issue" FOREIGN KEY ("issue_id") REFERENCES "issues" ("issue_id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "issue_fact" ADD CONSTRAINT "fk_issue_fact_fact" FOREIGN KEY ("fact_id") REFERENCES "facts" ("fact_id") ON DELETE CASCADE ON UPDATE CASCADE;
