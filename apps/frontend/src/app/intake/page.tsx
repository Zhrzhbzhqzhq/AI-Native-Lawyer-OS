    ...
    <main>
      <section style={{ maxWidth: 900, margin: '0 auto', padding: 20 }}>
        ...
        <div style={{ marginTop: 16 }}>
          ...
          >
            <div style={{ marginBottom: 8 }}>拖拽文件到这里</div>
            <input
              ref={fileInputRef}
              type="file"
              multiple
        ...
        <div style={{ marginTop: 16 }}>
          ...
          <select value={source} onChange={(e) => setSource(e.target.value as any)} style={{ width: '100%', padding: 10, borderRadius: 8, border: '1px solid #cbd5e1' }}>
